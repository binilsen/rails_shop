...
# units
units = [{ kilogram: 'kg' }, { gram: 'g' }, { milligram: 'mg' }, { liter: 'l' }, { milliliter: 'ml' }]
User.destroy_all
Order.destroy_all
Product.destroy_all
Unit.destroy_all
units.each do |item|
  item.each { |key, value| Unit.create(name: key, symbol: value) }
end
units = Unit.all
Product.create(product_name: 'Sugar',
               ...
               product_weight: 1, product_price: 80.0, unit_id: units.find_by(symbol: 'kg').id)
Product.create(product_name: 'Rice',
               ...
               product_weight: 1, product_price: 100.0, unit_id: units.find_by(symbol: 'kg').id)
Product.create(product_name: 'Wheat',
               ...
               product_weight: 1, product_price: 60.0, unit_id: units.find_by(symbol: 'kg').id)
Product.create(product_name: 'Black Pepper',
               ...
               product_weight: 250, product_price: 80.0, unit_id: units.find_by(symbol: 'g').id)
Product.create(product_name: 'Sugar',
               ...
               product_weight: 500, product_price: 40.0, unit_id: units.find_by(symbol: 'g').id)
Product.create(product_name: 'Salt',
               ...
               product_weight: 1, product_price: 22.0, unit_id: units.find_by(symbol: 'kg').id)
Product.create(product_name: 'Maida',
               ...
               product_weight: 500, product_price: 20.0, unit_id: units.find_by(symbol: 'g').id)
Product.create(product_name: 'Turmeric Powder',
               ...
               product_weight: 100, product_price: 22.0, unit_id: units.find_by(symbol: 'g').id)
Product.create(product_name: 'Gold Winner Sunflower Oil',
               ...
               product_weight: 1, product_price: 195.0, unit_id: units.find_by(symbol: 'l').id)
Product.create(product_name: 'Almonds',
               ...
               product_weight: 500, product_price: 389.0, unit_id: units.find_by(symbol: 'g').id)
